  ...
  return (
    <div className='row'>
       ...
       <div className="row-poster">
        ...
        {
          movies.map((movie)=>{
            return <img onClick={()=>{handleTrailer(movie)}} src={`${baseUrl_image}${isLarge ?movie.poster_path:movie.backdrop_path}`} alt="hello" className={`row-poster-image ${isLarge && "largeImage"}` } key={movie.id}/>
